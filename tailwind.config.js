...
export default {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gdg-gradient': 'linear-gradient(135deg, #EA4335 0%, #4285F4 25%, #FBBC04 50%, #34A853 75%, #EA4335 100%)',
        'hero-pattern': 'radial-gradient(circle at 25% 25%, rgba(66, 133, 244, 0.1) 0%, transparent 50%), radial-gradient(circle at 75% 75%, rgba(234, 67, 53, 0.1) 0%, transparent 50%)',
      },
      boxShadow: {
      ...
      keyframes: {
        ...
        'pulse-glow': {
          ...
          '50%': { boxShadow: '0 0 20px rgba(66, 133, 244, 0.8), 0 0 30px rgba(66, 133, 244, 0.6)' }
        }
      },
      animation: {
